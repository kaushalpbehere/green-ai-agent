...
class TestProject:
    ...
    def test_create_project(self):
        ...
        project = Project(name="MyApp", repo_url="https://github.com/user/myapp.git", language="python")
    ...
    def test_project_to_dict(self):
        ...
        project = Project(name="MyApp", repo_url="https://github.com/user/myapp.git", language="python")
        # In Pydantic model, violations must be list of Violations or handled by validator
        # For testing to_dict, we can manually set properties if needed, but safer to use update_scan_results
        # Or constructing objects
        from src.core.domain import Violation, ViolationSeverity
        project.violations = [Violation(id='v1', line=1, severity=ViolationSeverity.LOW, message="msg")]
        data = project.to_dict()
        assert data['name'] == "MyApp"
        assert data['repo_url'] == "https://github.com/user/myapp.git"
        assert data['language'] == "python"
        assert 'id' in data
        assert data['violations'][0]['id'] == 'v1'
    ...
    def test_project_from_dict(self):
        ...
        data = {
            ...
            'violations': [{'id': 'v1', 'line': 1, 'severity': 'low', 'message': 'msg'}]
        }
    ...
    def test_project_grade_no_violations(self):
        ...
        project = Project(name="App", repo_url="https://github.com/user/app.git")
    ...
    def test_project_update_scan_results(self):
        ...
        violations_list = [
            {'id': 'v1', 'line': 1, 'message': 'msg', 'severity': 'high'},
            {'id': 'v2', 'line': 2, 'message': 'msg', 'severity': 'medium'},
            {'id': 'v3', 'line': 3, 'message': 'msg', 'severity': 'low'}
        ]
